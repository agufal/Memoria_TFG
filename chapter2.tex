...
\begin{figure}[h]%t=top, b=bottom, h=here
    ...
    \includegraphics[scale=0.5]{figures/ble_hardware.png} % TODO hacer que esto no quede horrible
...
\begin{figure}[h]%t=top, b=bottom, h=here
    ...
    \includegraphics[scale=0.5]{figures/ble_physical_layer.png} % TODO hacer que esto no quede horrible
...
\begin{figure}[h]%t=top, b=bottom, h=here
	\centering
    \includegraphics[width=4in]{figures/ble_scan_example.png} % TODO hacer que esto no quede horrible
...
\begin{figure}[h]%t=top, b=bottom, h=here
	\centering
    \includegraphics[scale=0.5]{figures/ble_scan_response.png} % TODO hacer que esto no quede horrible
