...
Una vez implementado el módulo BLE en la aplicación móvil y establecer la conexión con la placa, necesitábamos visualizar los datos en una de las vistas.
