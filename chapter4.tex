...
\begin{figure}[h]%t=top, b=bottom, h=here
	\centering 	
    \includegraphics[width=\textwidth]{figures/psoc_compilador.PNG} % TODO hacer que esto no quede horrible
...
Como ya mencionamos en el Capítulo~\ref{makereference3}, la decisión de continuar la fase final del proyecto con una placa u otra fue difícil, pues ambas tienen características similares y sus entornos de desarrollo tienen sus pros y sus contras, pero finalmente escogimos la placa de desarrollo nRF51-DK de Nordic. %TODO Por que???